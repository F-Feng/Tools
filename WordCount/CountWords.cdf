   ...
   TagBox[GridBox[{
      {
       TemplateBox[{InputFieldBox[
          Dynamic[$CellContext`TeXIn$$], String, ImageSize -> 400]},
        "RowDefault"], 
...
$CellContext`ApsCount[$CellContext`TeXIn$$]),
        Evaluator->Automatic,
    ...
    "Grid"]],
  DynamicModuleValues:>{},
  Initialization:>($CellContext`ApsCount[
...
$CellContext`eqc, $CellContext`fgc}, $CellContext`envList = {
       "equation", "equation*", "eqnarray", 
        "eqnarray*"}; $CellContext`eqList = ($CellContext`eqnList = \
...
{}))))))); $CellContext`tex = 
      ...
      StringReplace[$CellContext`tex, {
        "\\maketitle" -> "%\\maketitle", "\\documentclass[" -> 
         ...
         "\\end{document}\n\\begin{acknowledgments}", "\\includegraphics[" -> 
         "%\\includegraphics["}]; $CellContext`cmdList = Flatten[
        Table[{
      ...
      StringReplace[$CellContext`tex, {
        RegularExpression[
          "([^%])\\s*\\\\begin\\{equation\\}((.|\\s)*?)[^%]\\s*\\\\end\\{\
equation\\}"] :> (AppendTo[$CellContext`eqList, "$2"]; "$1"), 
         RegularExpression[
          "([^%])\\s*\\\\begin\\{equation\\*\\}((.|\\s)*?)[^%]\\s*\\\\end\\{\
equation\\*\\}"] :> (AppendTo[$CellContext`eqList2, "$2"]; "$1"), 
         RegularExpression[
          "([^%])\\s*\\\\begin\\{eqnarray\\}((.|\\s)*?)[^%]\\s*\\\\end\\{\
eqnarray\\}"] :> (AppendTo[$CellContext`eqnList, "$2"]; "$1"), 
         RegularExpression[
          "([^%])\\s*\\\\begin\\{eqnarray\\*\\}((.|\\s)*?)[^%]\\s*\\\\end\\{\
eqnarray\\*\\}"] :> (AppendTo[$CellContext`eqnList2, "$2"]; "$1"), 
         RegularExpression[
          "(\\\\begin\\{table\\}((.|\\s)*?)[^%])\\s*\\\\begin\\{tabular\\}((.|\
\\s)*?)[^%]\\s*\\\\end\\{tabular\\}"] :> (AppendTo[$CellContext`tbList, "$4"]; 
          "$1"), 
         RegularExpression[
          "(\\\\begin\\{table*\\}((.|\\s)*?)[^%])\\s*\\\\begin\\{tabular\\}((.\
|\\s)*?)[^%]\\s*\\\\end\\{tabular\\}"] :> (
          AppendTo[$CellContext`tbList2, "$4"]; "$1"), 
         RegularExpression[
          "([^%])\\s*\\\\begin\\{figure\\}((.|\\s)*?)[^%]\\s*\\\\end\\{figure\
\\}"] :> (AppendTo[$CellContext`fgList, "$2"]; "$0"), 
         RegularExpression[
          "([^%])\\s*\\\\begin\\{figure\\*\\}((.|\\s)*?)[^%]\\s*\\\\end\\{\
figure\\*\\}"] :> (AppendTo[$CellContext`fgList2, "$2"]; "$0")}]; SetDirectory[
       ToFileName[{
